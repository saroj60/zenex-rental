...
const initialVehicles = [
  { id: 2, name: 'Toyota Land Cruiser & Fortuner', type: 'SUV / 4x4', price: 18000, priceWithDriver: 22000, img: '/images/Fortuner/2021-Toyota-Fortuner-India-Launch-Image1.jpg', seats: 7, trans: 'Automatic/Manual', fuel: 'Diesel', luggage: 4, rating: 4.9, seoTitle: 'Hire Toyota Land Cruiser & Fortuner 4x4 in Nepal - Zenex Travels', seoDescription: 'Premium Toyota Land Cruiser & Fortuner 4x4 SUV rental in Kathmandu. Perfect for mountain drives, offroad tours, and luxury travel.' },
  { id: 4, name: 'Toyota Hiace', type: 'Van / Micro', price: 9000, priceWithDriver: 12000, img: '/images/Hiace/toyota-hiace.jpg', seats: 14, trans: 'Manual', fuel: 'Diesel', luggage: 6, rating: 4.7, seoTitle: 'Rent Toyota Hiace Minibus in Kathmandu - 13 Seater Zenex Travel', seoDescription: 'Spacious Toyota Hiace Minibus rental for group tours and family trips in Nepal. Comfortable seating for up to 14 passengers. Experienced drivers included.' },
  ...
  { id: 6, name: 'Standard Car', type: 'Sedan/Hatchback', price: 5500, priceWithDriver: 7000, img: '/images/standard cars/2025-Geely-Emgrand-5-Seater-Sedan-1-5L-Munal-Longteng-Petrol-Gasoline-New-Car-Hot-Sale-New-Electric-Petrol-Car-Automatic.avif', seats: 4, trans: 'Manual', fuel: 'Petrol', luggage: 2, rating: 4.8, seoTitle: 'Rent Standard Car & Sedan in Kathmandu - Zenex Travels', seoDescription: 'Hire standard sedan or hatchback cars for comfortable city tours and inter-city travels in Nepal.' },
  { id: 7, name: 'Tourist Bus', type: 'Bus', price: 15000, priceWithDriver: 18000, img: '/images/Buses/329123096.jpg', seats: 35, trans: 'Manual', fuel: 'Diesel', luggage: 15, rating: 4.9, seoTitle: 'Rent Tourist Bus in Nepal - Zenex Travels', seoDescription: 'Rent comfortable 30-35 seater tourist bus for group sightseeing tours across Pokhara, Chitwan, and Lumbini.' },
  { id: 8, name: 'Toyota Coaster', type: 'Bus', price: 12000, priceWithDriver: 15000, img: '/images/Toyota Coaster/toyota-coaster-25.DPc5IpWM_ZMWAxw.webp', seats: 22, trans: 'Manual', fuel: 'Diesel', luggage: 8, rating: 4.8, seoTitle: 'Rent Toyota Coaster in Kathmandu - Zenex Travels', seoDescription: 'Spacious 22-seater Toyota Coaster rental with professional driver. Best for medium-sized group tours in Nepal.' },
