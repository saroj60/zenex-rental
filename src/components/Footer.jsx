      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 md:gap-8 mb-16">
          <div className="col-span-1">
            <h2 className="text-2xl font-bold text-white mb-4">NepalDrive</h2>
            ...
            <div className="flex flex-wrap gap-4 text-blue-300">
              ...
              <a href="#" aria-label="Twitter">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="hover:text-white cursor-pointer transition-colors"><path d="M23 3a10.9 10.9 0 0 1-3.14 1.53 4.48 4.48 0 0 0-7.86 3v1A10.66 10.66 0 0 1 3 4s-4 9 5 13a11.64 11.64 0 0 1-7 2c9 5 20 0 20-11.5a4.5 4.5 0 0 0-.08-.83A7.72 7.72 0 0 0 23 3z"/></svg>
              </a>
              <a href="#" aria-label="YouTube">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="hover:text-white cursor-pointer transition-colors"><path d="M22.54 6.42a2.78 2.78 0 0 0-1.94-2C18.88 4 12 4 12 4s-6.88 0-8.6.46a2.78 2.78 0 0 0-1.94 2A29 29 0 0 0 1 11.75a29 29 0 0 0 .46 5.33 2.78 2.78 0 0 0 1.94 2c1.72.46 8.6.46 8.6.46s6.88 0 8.6-.46a2.78 2.78 0 0 0 1.94-2 29 29 0 0 0 .46-5.33 29 29 0 0 0-.46-5.33z"/><polygon points="9.75 15.02 15.5 11.75 9.75 8.48 9.75 15.02"/></svg>
              </a>
          ...
          <div className="flex flex-col gap-3">
            ...
            <Link className="text-blue-200 text-sm hover:text-white transition-colors w-fit" to="/blog">Blog</Link>
          ...
          <div className="flex flex-col gap-3">
            ...
            <p className="text-blue-200 text-sm">Thamel, Kathmandu, Nepal</p>
            <p className="text-blue-200 text-sm">+977 1-4212345</p>
            <p className="text-blue-200 text-sm hover:text-white cursor-pointer transition-colors w-fit">info@nepaldrive.com</p>
            <a href="https://wa.me/9779800000000?text=Hi!%20I%20need%20help%20booking%20a%20car." target="_blank" rel="noreferrer" className="mt-2 inline-flex items-center gap-2 bg-[#25D366] text-white px-5 py-2.5 rounded-lg text-[13px] font-bold hover:bg-[#1DA851] transition-colors w-max shadow-md hover:shadow-lg">
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row items-center justify-center">
          <p className="text-blue-300 text-sm font-medium">
            © {new Date().getFullYear()} NepalDrive Premium. Elevating Himalayan Journeys.
          </p>
        </div>
      </div>
    </footer>
