      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="col-span-1 md:col-span-4 space-y-6">
            ...
            <div className="flex items-center gap-3 pt-2">
              <a 
                ...
                target="_blank" 
                rel="noreferrer" 
                className="w-10 h-10 rounded-xl bg-slate-800/80 border border-slate-700/60 flex items-center justify-center text-slate-300 hover:bg-[#1877F2] hover:text-white hover:border-[#1877F2] hover:-translate-y-1 transition-all duration-300 shadow-sm"
                aria-label="Facebook"
              >
              ...
              <a 
                ...
                target="_blank" 
                rel="noreferrer" 
                className="w-10 h-10 rounded-xl bg-slate-800/80 border border-slate-700/60 flex items-center justify-center text-slate-300 hover:bg-[#E4405F] hover:text-white hover:border-[#E4405F] hover:-translate-y-1 transition-all duration-300 shadow-sm"
              ...
              <a 
                ...
                target="_blank" 
                rel="noreferrer" 
                className="w-10 h-10 rounded-xl bg-slate-800/80 border border-slate-700/60 flex items-center justify-center text-slate-300 hover:bg-[#FF0000] hover:text-white hover:border-[#FF0000] hover:-translate-y-1 transition-all duration-300 shadow-sm"
                aria-label="YouTube"
              >
              ...
              <a 
                ...
                target="_blank" 
                rel="noreferrer" 
                className="w-10 h-10 rounded-xl bg-slate-800/80 border border-slate-700/60 flex items-center justify-center text-slate-300 hover:bg-[#000000] hover:text-white hover:border-slate-500 hover:-translate-y-1 transition-all duration-300 shadow-sm"
                aria-label="TikTok"
              >
        ...
        <div className="border-t border-slate-800/40 pt-8 pb-4 grid grid-cols-1 md:grid-cols-3 items-center gap-8 mt-8">
          ...
          <div className="flex flex-col items-center">
            ...
            <Link 
              to="/vehicles"
              className="flex items-center gap-3 group bg-slate-900/60 p-2.5 rounded-xl border border-slate-850 hover:border-slate-700 hover:bg-slate-800/30 transition-all duration-300 shadow-inner w-full max-w-[240px]"
            >
              <img 
