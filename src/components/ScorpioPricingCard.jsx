...
const ScorpioPricingCard = () => {
  ...
  return (
    <div className="bg-white rounded-2xl p-4 shadow-sm border border-sky-tint hover:shadow-md transition-shadow group flex flex-col w-full max-w-sm mx-auto mb-12">
      <Link to="/vehicles/scorpio-routes" className="relative overflow-hidden rounded-lg mb-4 block cursor-pointer">
        <img 
      ...
      <h3 className="font-headline-md text-2xl font-bold text-gray-900 mb-1">Mahindra Scorpio</h3>
      ...
      <div className="grid grid-cols-2 gap-2 mb-6 mt-auto">
        <div className="bg-[#f0f4f8] rounded-xl p-3 text-center flex flex-col items-center justify-center">
          ...
          <span className="text-sm font-semibold text-[#1e3a8a]">7 Seats</span>
        </div>
        <div className="bg-[#f0f4f8] rounded-xl p-3 text-center flex flex-col items-center justify-center">
...
export default ScorpioPricingCard;
