  ...
  return (
    <div className="max-w-6xl mx-auto pb-20">
      <div className="mb-8 flex justify-between items-end">
        ...
        <button type="button" onClick={handleSubmit} className="bg-[#1e3a8a] text-white px-6 py-2.5 rounded-xl font-bold flex items-center gap-2 hover:bg-blue-900 shadow-md"><Save size={18} /> Save Changes</button>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 flex flex-wrap gap-4 items-center justify-between sticky bottom-4 z-50">
          ...
          <button type="submit" className="bg-[#e53a24] text-white px-10 py-4 rounded-xl font-bold text-lg flex items-center gap-2 hover:bg-red-700 shadow-xl hover:-translate-y-1 transition-all"><Save size={24} /> Save Changes</button>
        </div>
