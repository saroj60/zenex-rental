        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {filteredTreks.length > 0 ? (
            ...
            <div className="text-center py-20 bg-slate-50 rounded-2xl border border-slate-100">
              ...
              <p className="text-slate-500 mt-2 mb-6">All tour packages have been removed from the treks section. You can add new trekking packages via the Admin Dashboard or explore all treks.</p>
