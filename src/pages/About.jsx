      ...
      <div className="relative h-[60vh] min-h-[500px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto mt-16">
          ...
          <p className="text-lg md:text-2xl text-blue-100 font-medium max-w-3xl mx-auto drop-shadow-md leading-relaxed">
            We are Nepal's premier vehicle rental service, dedicated to providing safe, reliable, and premium transportation across the world's most breathtaking terrains.
          </p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="order-1 lg:order-2 space-y-6">
            ...
            <p className="text-lg text-gray-600 leading-relaxed">
              NepalDrive was founded with a simple vision: to make navigating Nepal's beautiful but challenging landscapes safe, comfortable, and accessible. 
            </p>
            <p className="text-lg text-gray-600 leading-relaxed">
