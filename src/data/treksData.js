export const treksData = [
  ...
  },
  {
    ...
    groupDiscounts: [
      { pax: "2 - 3 Pax", price: "US$ 1,180" },
      { pax: "4 - 7 Pax", price: "US$ 985" },
      { pax: "8 - 11 Pax", price: "US$ 960" },
      { pax: "12 - 15 Pax", price: "US$ 910" }
    ],
    ...
    equipmentList: [
      { category: "Clothing", items: ["Moisture-wicking base layers", "Fleece jacket / down jacket", "Waterproof/windproof Gore-Tex jacket", "Trekking pants (2 pairs)", "Thermal leggings", "Warm beanie & sun cap", "Warm gloves (fleece + outer waterproof)"] },
      { category: "Footwear", items: ["Sturdy ankle-support trekking boots", "Camp shoes / sandals", "Moisture-wicking wool socks (3-4 pairs)"] },
      ...
      { category: "Hydration & Essentials", items: ["Water bottles / hydration bladder", "Water purification tablets/filter", "Sunscreen (SPF 50+) & lip balm", "First aid kit & personal medication"] }
    ],
    extendedInfo: [
      {
  ...
  },
  {
    ...
    groupDiscounts: [
      { pax: "2 - 3 Pax", price: "US$ 845" },
      { pax: "4 - 7 Pax", price: "US$ 765" },
      { pax: "8 - 11 Pax", price: "US$ 675" },
      { pax: "12 - 15 Pax", price: "US$ 655" }
    ],
    ...
    equipmentList: [
      { category: "Clothing", items: ["Moisture-wicking base layers (2-3)", "Fleece jacket / down jacket", "Waterproof Gore-Tex jacket", "Trekking pants (2)", "Thermal leggings", "Warm beanie & sun hat", "Fleece + waterproof gloves"] },
  ...
  },
  {
    ...
    groupDiscounts: [
      { pax: "2 - 3 Pax", price: "US$ 1,145" },
      { pax: "4 - 7 Pax", price: "US$ 995" },
      { pax: "8 - 11 Pax", price: "US$ 905" },
      { pax: "12 - 15 Pax", price: "US$ 870" }
    ],
  ...
  },
  {
    ...
    groupDiscounts: [
      { pax: "1 - 2 Pax", price: "US$ 1,450" },
      { pax: "3 - 5 Pax", price: "US$ 1,350" },
      { pax: "6 - 10 Pax", price: "US$ 1,250" },
      { pax: "11+ Pax", price: "US$ 1,180" }
    ],
    ...
    equipmentList: [
      { category: "Clothing", items: ["Moisture-wicking T-shirts", "Fleece jacket & heavy windproof jacket", "Comfortable pants & thermal leggings for cool nights", "Sun hat & warm beanie", "Lightweight gloves"] },
      { category: "Footwear", items: ["Comfortable walking/hiking shoes with good traction", "Camp sandals or crocs for lodge wear"] },
      { category: "Backpacking & Travel Gear", items: ["Daypack (20-30L) for personal items", "Duffel bag (provided by Zenex Travels)", "Sleeping bag rated to -10°C (optional, rental available in Kathmandu/Pokhara)"] },
      { category: "Personal Care & Toiletries", items: ["Sunscreen (SPF 50+) & lip balm with SPF", "Water purification tablets or filter bottle", "Wet wipes, hand sanitizer & personal medication"] }
    ],
    extendedInfo: [
      {
  ...
  },
  {
    ...
    groupDiscounts: [
      { pax: "1 - 3 Pax", price: "US$ 2,280" },
      { pax: "4 - 7 Pax", price: "US$ 2,150" },
      { pax: "8 - 11 Pax", price: "US$ 2,050" },
      { pax: "12 - 15 Pax", price: "US$ 1,960" }
    ],
  ...
  },
  {
    ...
    meals: "Breakfast in Kathmandu, All Meals (Breakfast, Lunch & Dinner) on Trek",
    bestSeason: "Spring (March - May) & Autumn (Sept - Nov)",
    image: "https://www.pioneeradventure.com/uploads/images/2018-12-17_21:23:26-68X8BhWGUeyIZBDdGao7f2EBZcQh1D.jpeg",
    gallery: [
...
This route combines basic lodges in gateway towns (Burtibang, Dhorpatan, Ringmo, Juphal) with full wilderness camping across remote high passes (Pagune Lekh, Jangla La, Numa La, Bagala). All meals during camping days are freshly prepared by our expedition cook staff.`,
  ...
  },
  {
    ...
    groupDiscounts: [
      { pax: "1 - 3 Pax", price: "US$ 2,150" },
      { pax: "4 - 7 Pax", price: "US$ 1,980" },
      { pax: "8 - 11 Pax", price: "US$ 1,850" }
    ],
  ...
  },
  {
    ...
    groupDiscounts: [
      { pax: "1 - 3 Pax", price: "US$ 2,500" },
      { pax: "4 - 7 Pax", price: "US$ 2,300" },
      { pax: "8 - 11 Pax", price: "US$ 2,100" },
      { pax: "12 - 15 Pax", price: "US$ 2,000" }
    ],
  ...
  },
  {
    ...
    groupDiscounts: [
      { pax: "1 - 3 Pax", price: "US$ 2,850" },
      { pax: "4 - 7 Pax", price: "US$ 2,650" },
      { pax: "8 - 11 Pax", price: "US$ 2,480" }
    ],
  ...
  },
  {
    ...
    meals: "Breakfast, Lunch & Dinner",
    bestSeason: "Spring & Autumn",
    image: "https://www.alpineadventureclub.com/_next/image?url=https%3A%2F%2Fwww.alpineadventureclub.com%2Fuploads%2Flapchi_trek_03_3536122f82.webp&w=3840&q=75",
    gallery: [
    ...
    groupDiscounts: [
      { pax: "1 - 3 Pax", price: "US$ 1,650" },
      { pax: "4 - 7 Pax", price: "US$ 1,500" },
      { pax: "8 - 11 Pax", price: "US$ 1,380" }
    ],
...
Organized by Zenex Travels & Tours with full safety equipment, experienced mountain guides, private transfers, and permit arrangements, this 18-day Makalu expedition guarantees an exceptional Himalayan trek.`,
    ...
    equipmentList: [
      {
        category: "Clothing & Layers",
        items: ["Thermal base layers (top & bottom)", "Fleece jacket / mid-layer pull-overs", "Waterproof & windproof hard shell jacket & pants", "Down jacket rated for -15°C", "Quick-dry trekking trousers (2-3 pairs)", "Long-sleeve moisture-wicking shirts"]
      },
      {
        category: "Footwear",
        items: ["Sturdy, broken-in waterproof trekking boots", "Camp shoes or light sandals", "4-5 pairs of merino wool trekking socks", "Gaiters for snow & gravel protection"]
      },
      {
        category: "Head, Hands & Eye Protection",
        items: ["Warm beanie / fleece hat", "Sun hat / baseball cap", "UV-protection glacier sunglasses", "Lightweight liner gloves", "Waterproof, warm fleece/down mittens"]
      },
      {
        category: "Gear & Accessories",
        items: ["40-50L daypack with rain cover", "Sleeping bag rated for -15°C to -20°C", "Trekking poles (pair)", "Headlamp with extra batteries / powerbank", "1L or 2L insulated water bottles & purification tablets", "Microspikes / Crampons (for high passes)"]
      },
      {
        category: "Personal & Medical",
        items: ["Personal first aid kit with altitude medication (Diamox)", "Sunscreen SPF 50+ & lip balm", "Quick-dry microfiber towel", "Biodegradable wet wipes & hand sanitizer"]
      }
    ],
    whyTrekWithUs: [
      {
  ...
  },
  {
    ...
    rating: 4.9,
    reviewsCount: 143,
    image: "https://admin.buddhaair.com/upload/blog/thumbnail/1574327215_jYmkI_1567571648-ebeyj-makalu.webp",
...
Organized with full expedition support by Zenex Travels & Tours, including certified climbing Sherpas, tented camping infrastructure, satellite communications, and specialized safety gear, this trek offers an unforgettable journey far from commercial trails.`,
  ...
  },
  {
    ...
    rating: 4.9,
    reviewsCount: 143,
    image: "https://www.bestheritagetour.com/public/images/upload/package/slider/api-himal-trek-5-1.jpg",
...
Organized by Zenex Travels & Tours with full logistics, private 4WD transfers, experienced mountain guides, and complete camping infrastructure, this 14-day expedition delivers an extraordinary journey into Nepal's uncharted western frontier.`,
  ...
  },
  {
    ...
    rating: 4.9,
    reviewsCount: 143,
    image: "https://media.nepaltrekadventures.com/uploads/package/gallery/thumb/rara-lake-trek.webp",
